...
const makeEditUserForm = (o) => {
	...
	<div class="profile-head">
				<img src="${o.img}" alt="" class="hamsteroneprofile">
			</div>
		...
		<div class="form-control">
			<label for="edit-user-phone" class="user-label">Phone Number</label>
			<input class="user-input" type="text" placeholder="Type your Phone Number" data-role="none" id="edit-user-phone" value="${o.phone}">
		</div>
		<div class="form-control">
			<label for="edit-user-address" class="user-label">Address</label>
			<input class="user-input" type="text" placeholder="Type your Address" data-role="none" id="edit-user-address" value="${o.address}">
		</div>
		<div class="form-control">
					<a href="#profile-page" class="js-edituser">Done</a>
				</div>
	</form>
	`;
}
